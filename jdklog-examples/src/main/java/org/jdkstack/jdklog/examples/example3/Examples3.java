...
public class Examples3 {
  ...
  public void main(int i) {
    log.error("Examples3>error>>>>我要去的日志文件是3study,当前的日志计数是:{}", "" + i);
    log.info("Examples3>info>>>>我要去的日志文件是3study,当前的日志计数是:{}", "" + i);
    log.warn("Examples3>warn>>>>我要去的日志文件是3study,当前的日志计数是:{}", "" + i);
