...
public final class Constants {
  ...
  public static final String DEFAULT_HANDLERS_SINGLE =
      "org.jdklog.logging.core.handler.FileHandler";
  /** 日志消息中有多个大括号对. */
  public static final String BRACE = "{}";
  /** . */
  public static final String FORMATTER =
      "org.jdklog.logging.core.formatter.StudyJuliMessageTextFormatter";
  /** . */
  public static final String FILTER = "org.jdklog.logging.core.filter.StudyJuliFilter";
  /** . */
  public static final String FORMATTER_NAME =
      "org.jdklog.logging.core.handler.ConsoleHandler.formatter";
  /** . */
  public static final String CONFIG_FILE = "org.jdklog.logging.core.config.file";
  /** . */
  public static final String LOG_MANAGER = "org.jdklog.logging.core.manager";
  /** . */
  public static final String STUDY_JULI_LOG_MANAGER =
      "org.jdklog.logging.core.manager.StudyJuliLogManager";
  /** . */
